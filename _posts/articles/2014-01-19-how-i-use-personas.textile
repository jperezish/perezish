...
Good thing I went and talked to other people. I mean I really could've went down a path of applying my own mental model onto the thing I want to build. Seeing as how I'm a potential user of this app it's not necessarily a bad thing, but just like picking your nose in public, it's not a good habit to have. I now see that I simply can't think of replacing a software based spreadsheet with another digital alternative. Nope. I'll now need to think about how to help out Inigo as well.
