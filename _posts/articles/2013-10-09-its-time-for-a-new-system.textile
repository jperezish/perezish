...
Now I'm not assuming Phil just transcribed verbatim what Kim said. Let's say he did his due diligence and asked some probing questions, but are there more perspectives to consider? Kim did mention 2 other types of people:
...
* Not getting assigned stuff I can't do
  ...
  <figcaption class="small-10 small-centered columns">
    Phil met with Carl and got some good information on the facility worker's perspective.
  </figcaption>
</figure>
...
* Being able to easily submit a new request
  ...
  <figcaption class="small-10 small-centered columns">
    Arthur represents the group of people requesting things from facilities.
  </figcaption>
</figure>
...
* Keeping track of how much these requests cost
  ...
  <figcaption class="small-10 small-centered columns">
    Phil gathered this information from his meeting with Kim.
  </figcaption>
</figure>
...
He doesn't have the whole truth (he never really does in the beginning). But he uses Columbo's MO, playing naive as a means of extracting more information about the problem from the various people he meets with. He knows it's not important for him to relay to each person what he knows about the problem, it's more important to listen to each person and figure out what their view is. As Phil goes about his fact finding mission he finds out that there 12 facility worker employees in 4 different geographical locations.
...
I may've missed a few things, but the point isn't to convey the giant list of things that Phil needs to know. The point is to see a snippet of some of the more important items that will help guide Phil and the other folks down a path to solving the right problem or problems.
